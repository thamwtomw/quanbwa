...
const SITE_URL = 'https://an-hoang-trung-tuong-2014.blogspot.com';
...
async function generateFiles() {
    ...
    // 1. Create JSON file
    fs.writeFileSync('2014.json', JSON.stringify(allPosts, null, 2));
...
<body>
    ...
    fs.writeFileSync('2014.html', htmlContent);
    console.log('\nSuccess: created 2014.json and 2014.html');
}
